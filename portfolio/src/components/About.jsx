          ...
          <Grid item xs={12} md={6}>
            <Paper elevation={3} sx={{ p: 3, bgcolor: 'rgba(255, 255, 255, 0.9)' }}>
              ...
              <Typography paragraph>
               Hi, I’m Karthikeya Akudhari — a passionate and curious full-stack web developer with a knack for building intuitive, user-friendly web applications. I enjoy turning complex problems into simple, elegant solutions through clean code and thoughtful design.
